...
# 필터링된 결과를 저장할 리스트
filtered_genian_logs = []
filtered_fortigate_logs = []

def search_genian_logs(start_time=None, end_time=None):
    global filtered_genian_logs
...
def search_fortigate_logs(start_time=None, end_time=None):
    global filtered_fortigate_logs
    ...
    for hit in result['hits']['hits']:
        ...
        filtered_fortigate_logs.append({
            "timestamp": timestamp,
            "src_ip": src_ip,
            "dst_ip": dst_ip,
            "srcintf": srcintf,
